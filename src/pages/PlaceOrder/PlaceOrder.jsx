                    ...
                    <div className="placeorderRight">
                        ...
                        <div className="placementMethod">
                            ...
                            <div className="methodsContainer">
                                <div onClick={() => setMethod("stripe")} className="stripe method">
                                    <div className={method === "stripe" ? "circle green" : "circle"}></div>
                                    <img src={assets.stripe_logo} alt="no img" />
                                </div>
                                <div onClick={() => setMethod("razorpay")} className="razorpay method">
                                    <div className={method === "razorpay" ? "circle green" : "circle"}></div>
                                    <img src={assets.razorpay_logo} alt="no img" />
                                </div>
