                        ...
                        <div className={displayFilter? "formContainer displayFilterContainer" : "formContainer"}>
                            ...
                            <form className="filterBox">
                                ...
                                <div className="inputField">
                                    <input type="checkbox" value={"Shuttle Lace"} onChange={toggleCategory} />
                                    <p>Shuttle Lace</p>
                                </div>
                                <div className="inputField">
                                    <input type="checkbox" value={"Fancy Lace"} onChange={toggleCategory} />
                                    <p>Fancy Lace</p>
                                </div>
                                <div className="inputField">
                                    <input type="checkbox" value={"Patches"} onChange={toggleCategory} />
                                    <p>Patches</p>
                                </div>
                            </form>
                            {/* Filter Box */}
